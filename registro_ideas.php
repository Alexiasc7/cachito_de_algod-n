                    ...
                    <div class="container">
                        <div class="row">
                          <div id="form-login" class="col-md-6 col-md-offset-3">
                            ...
                            <form class="searchable" action="registro_ideas.php" method="post" id="formularioinsertar" name="formularioinsertar" enctype="multipart/form-data">                         
                            <div class="form-group">
                            <input type="text" id="id_idea" name="id_idea" value="<?php echo @$idemod[0][0]; ?>"  hidden>     
                            <div class="form-group">
                                <input name="nombre" id="nombre" onkeypress="return soloLetras(event)" value="<?php echo @$idemod[0][1]; ?>" type="text" class="form-login" placeholder="Titulo" required>
                              </div>
